...
public class ShapeFile {
    private String imgSrc; //where to find picture used as drawing template
    ...
    public ShapeFile(String imgSrc,int fileAmount) {
        this.imgSrc = imgSrc; //New file is created by uploading an image, therefore there will always be this value when creating new file
